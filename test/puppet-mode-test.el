...
(ert-deftest puppet-skeleton/puppet-filename-parser-unix ()
  :tags '(skeleton)
  (should (equal (puppet-filename-parser "/modules/foo/manifests/init.pp")
                 '("foo")))
  (should (equal (puppet-filename-parser "/modules/foo/manifests/bar.pp")
                 '("foo" "bar")))
  (should (equal (puppet-filename-parser "/modules/foo/manifests/bar/baz.pp")
                 '("foo" "bar" "baz"))))

(ert-deftest puppet-skeleton/puppet-filename-parser-windows ()
  :tags '(skeleton)
  (should (equal (puppet-filename-parser "C:/modules/foo/manifests/init.pp")
                 '("foo")))
  (should (equal (puppet-filename-parser "C:/modules/foo/manifests/bar.pp")
                 '("foo" "bar")))
  (should (equal (puppet-filename-parser "C:/modules/foo/manifests/bar/baz.pp")
                 '("foo" "bar" "baz"))))

(ert-deftest puppet-skeleton/puppet-filename-parser-unidentified ()
  :tags '(skeleton)
  (should (equal (puppet-filename-parser "/modules/init.pp")
                 '("unidentified")))
  (should (equal (puppet-filename-parser "/modules/foo/init.pp")
                 '("unidentified")))
  (should (equal (puppet-filename-parser "/modules/foo/bar/init.pp")
                 '("unidentified"))))

(ert-deftest puppet-skeleton/puppet-filename-parser-nil ()
  :tags '(skeleton)
  (should (equal (puppet-filename-parser nil)
                 '("unidentified"))))

(ert-deftest puppet-skeleton/puppet-filename-parser-invalid-module ()
  :tags '(skeleton)
  (should (equal (puppet-filename-parser "/puppet-foo/manifests/init.pp")
                 '("foo"))))
